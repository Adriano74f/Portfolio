<style>
    ...
    @media (max-width: 768px) {
        ...
        .skills-table { min-width: 480px; font-size: .72rem; }
        .skills-table th, .skills-table td { padding: 6px 8px; }

        /* Source veille — texte qui déborde */
        .source-block        { overflow: hidden; }
        .source-name         { word-break: break-word; white-space: normal; font-size: .72rem; }
        .source-list li,
        .source-list a       { word-break: break-word; white-space: normal; font-size: .65rem; }
        .veille-topic-box    { flex-wrap: wrap; }
        .vt-title            { font-size: .85rem; word-break: break-word; }

        /* Tags */
        .skill-tag, .tech-tag { font-size: .58rem; }
        .tech-tags, .skill-tags { gap: 4px; }

        /* Btn download */
        .btn-download { font-size: .72rem; padding: 8px 12px; }
    }
